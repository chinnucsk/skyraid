...
-export([authorize_url/0, access_token/1, account_info/1, list_files/1, write_file/3, read_file/2]).
...
access_token(#skr_auth_reqtoken{provider=dropbox, token=[{"oauth_token_secret", TokenSecret}, {"oauth_token", Token}]}) ->
