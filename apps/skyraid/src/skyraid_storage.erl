...
-export([authorize_url/1, access_token/1, account_info/1, file_list/1, file_open/4, file_close/2, file_write/3, write_file/3, write_file/5, read_file/2, read_file/4]).
...
write_file(#skr_auth_acctoken{provider=dropbox}=AT, FileName, Content) ->
